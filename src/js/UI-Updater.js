...
export function CreatProductTemplate(product, includeDescription) {
  let forModalOrNot = !includeDescription
    ? 'style="max-height:90vh; overflow-y:scroll"'
    : '';
  let forModalOrNotBottomMargin = !includeDescription ? 'mb-0' : 'mb-5';
  let productSectionTemplate = `<div class="container">
                                  <div class="row">
                                    <div class="col-sm-12 col-md-6 ${forModalOrNotBottomMargin}">
                                      <div class="row">
                                        <div class="col-12 col-lg-3 img-Selection">
                                          <div class="d-flex flex-column" ${forModalOrNot}>
                                    ...
                                    <div class="col-sm-12 col-md-6 px-4" ${forModalOrNot}>
...
`;
  ...
  let descriptionSectionTemplate = `<!-- product description -->
  ...
  if (includeDescription) {
    return productSectionTemplate + descriptionSectionTemplate;
  } else {
